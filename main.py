...
LGUI = KC.HT(KC.NUBS, KC.LGUI, prefer_hold=True, tap_interrupted=False, tap_time=300)
...
keyboard.keymap = [
    [
        _______, _______,  KC.ESC,    LGUI,   KC.F4,    KC.G,   KC.F5,    KC.H,   KC.F6, _______, KC.QUOT, _______,   KC.P0, KC.PDOT,   KC.UP, KC.LALT,
